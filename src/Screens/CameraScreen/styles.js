...
const GuideBottomWrapperHeight = window.height - (BaseHeightOffset.head - 30) - BaseHeightOffset.foot;
...
export const GuideWrapper = styled.View`
  ...
  justify-content: center;
  align-items: center;
  background-color: ${(props) => !props.allowed ? 'rgba(221, 103, 112, 0.6)' : 'rgba(106,130,251,0.6)'};
`;
